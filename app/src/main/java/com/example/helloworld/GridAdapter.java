...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.LinearViewHolder> {
    ...
    public GridAdapter(Context context, OnItemClickListener listener, OnItemLongClickListener longlistener){
    ...
    public GridAdapter.LinearViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LinearViewHolder(LayoutInflater.from(mContext).inflate(R.layout.layout_recycler_grid_item,parent,false));
    }
